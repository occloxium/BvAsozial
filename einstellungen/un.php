<?php
/**
 * Updates a users notification setting in the DB
...
if(isset($_POST['allowNotifications'], $_POST['uid'])){
  if(login_check($mysqli)){
    if($stmt = $mysqli->prepare("UPDATE person SET allowedEmails = ? WHERE uid = ?;")){
