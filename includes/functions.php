	...
	function get_nav($active = ''){
		if(isset($_SESSION['username'])){
			echo '<nav class="navigation mdl-navigation mdl-color--blue-grey-800" data-active="#' . $active . '">
				<a class="mdl-navigation__link" href="/" id="home"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">home</i><span>Übersicht</span></a>
				<a class="mdl-navigation__link" href="/users/me/" id="users"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">face</i><span>Mein Profil</span></a>
				<a class="mdl-navigation__link" href="/freunde/meine-freunde/" id="my-friends"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">people</i><span>Meine Freunde</span></a>
				<a class="mdl-navigation__link" href="/freunde/" id="friends"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">person_pin</i><span>Freunde finden</span></a>
				<a class="mdl-navigation__link" href="/freunde/anfragen/" id="requests"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">person_add</i><span>Freundschafts-<br>anfragen</span></a>
				<a class="mdl-navigation__link" href="/fragen/" id="questions"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">question_answer</i><span>Fragen</span></a>
				...
				<a class="mdl-navigation__link" href="/support/" id="support"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">help_outline</i><span class="visuallyhidden">Help</span></a>
			</nav>';
		} else {
			echo '<nav class="navigation mdl-navigation mdl-color--blue-grey-800" data-active="#' . $active . '">
				<a class="mdl-navigation__link" id="home" href="/index.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">home</i><span>BvAsozial</span></a>
				...
				<a class="mdl-navigation__link" id="register" href="/registrieren/"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">face</i><span>Registrieren</span></a>
				<a class="mdl-navigation__link" id="about" href="/about/"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">supervisor_account</i><span>Über Uns</span></a>
				<div class="mdl-layout-spacer"></div>
