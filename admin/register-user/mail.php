...
<html xmlns="http://www.w3.org/1999/xhtml" style="margin: 0; padding: 0;">
  ...
  <body class="no-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #131814;">
      ...
      <div style="font-size: 30px;line-height: 30px;mso-line-height-rule: exactly;">&nbsp;</div>
			<div style="width: 300px; margin: 0 auto">
				...
				<div class="column" style="padding: 0;text-align: left;vertical-align: top; background: #131814; color: #ffffff;font-size: 14px;line-height: 21px;font-family: Roboto,Tahoma,sans-serif;width: 600px;">
					<div style="Margin-left: 20px;Margin-right: 20px;">
						<p style="Margin-top: 0;Margin-bottom: 0;">Benutzername: {$user['uid']}</p>
						<p style="Margin-top: 20px;Margin-bottom: 20px;">Passwort: {$_POST['password']}</p>
					</div>
					<div style="Margin-left: 20px;Margin-right: 20px;">
...
MAIL;
	...
	$mail->Username   = "abi.zeitung.bva2016@gmail.com"; // SMTP account username example
	$mail->Password   = "Kindheitshelden";        // SMTP account password example

	$mail->setFrom('abi.zeitung.bva2016@gmail.com', 'Abi-Zeitung BvA 2016');
	$mail->addAddress($_POST['email']);

	$mail->isHTML(true);
	$mail->Subject = 'Einladung zu BvAsozial.de - Steckbriefe der Abizeitung';
	$mail->Body = $body;
